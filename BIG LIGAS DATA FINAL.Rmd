...
```{r}
#### MERGES OWO ####
merge1=merge(compindex,datatec)
merge2=merge(merge1,debt)
merge3=merge(merge2,demo_index)
merge4=merge(merge3,electricity)
merge5=merge(merge4,gas_export)
merge6=merge(merge5,industry_growth)
merge7=merge(merge6,inflation_rate)
merge8=merge(merge7,militar)
merge9=merge(merge8,oilexport)
merge10=merge(merge9,stock_IED)
merge11=merge(merge10,superavit)
merge12=merge(merge11,tax)
dataBigLigas=merge(merge12,wpi)
```
