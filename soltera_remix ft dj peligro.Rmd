...
aggDIV=aggregate(as.matrix(cbind(LatenLigas[,c(9)]))~ clustDIV, data=LatenLigas,
...
```{r}
FullPower=merge(MAP@data,LatenLigas,by.x="name_long",by.y="Country")
AAAA=FullPower[,c(1,55)]
summary(AAAA)
names(FullPower)
```
